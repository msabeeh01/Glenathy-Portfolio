<script>
	...
	import ImageCardLinked from "$lib/ImageCard/ImageCardLinked.svelte";
...
<div data-aos="fade-up" class="flex flex-col place-items-center gap-10 text-center md:flex-row h-full">
